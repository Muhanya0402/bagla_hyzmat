const Map<String, String> stringsTk = {
  ...
  'onboardingSubtitle3':
      'Sargyt almak üçin tyllalar gerek. Her dereje günde +0.5 tylla awtomatiki berýär.',
  ...
  'orderCommentHint': 'Eltip berijä bellik (hökman däl)',
  ...
  'trafficMenu': 'Traffigiň derňewi',
  'trafficTitle': 'Traffigiň derňewi',
  'trafficToday': 'Şu gün',
  'trafficTotal': 'Ähli wagtda',
  'trafficAveragePerDay': 'Günde ortaça',
  'trafficForecast': 'Aýlyk çaklama',
  'trafficForecastHint': 'Programmany ulanan günleriňiz boýunça',
  'trafficSent': 'Ugradyldy',
  'trafficReceived': 'Kabul edildi',
  'trafficRequests': 'Servere ýüzlenme',
  'trafficSince': 'Hasap başlanan wagty',
  'trafficByDays': 'Günler boýunça, iki hepde',
  'trafficByCategory': 'Näme üçin sarp edildi',
  'trafficHeaviest': 'Iň agyr soraglar',
  'trafficCatOrders': 'Sargytlar',
  'trafficCatPhotos': 'Suratlar',
  'trafficCatNotifications': 'Habarlar',
  'trafficCatProfile': 'Profil',
  'trafficCatAuth': 'Girmek',
  'trafficCatOther': 'Beýlekiler',
  'trafficDisclaimer': 'Server bilen alyş-çalyş hasaplanýar. Öň ýüklenen suratlary görmek we täzelenmeler üçin hemişelik baglanyşyk bu ýere girmeýär — olary diňe telefonyň hasaplaýjysy görýär.',
  'trafficReset': 'Statistikany arassalamak',
  'trafficResetTitle': 'Statistikany arassalamalymy?',
  'trafficResetBody': 'Ýygnanan sanlar telefondan pozular. Internet sarpyýatyna täsir etmeýär.',
  'trafficResetConfirm': 'Arassalamak',
  'trafficResetCancel': 'Ýatyr',
  'reportCourierBtn': 'Eltip berijä şikaýat',
  'reportCourierTitle': 'Eltip berijä şikaýat',
  'reportCourierSubtitle': 'Näme bolanyny saýlaň. Şikaýaty ulgam seljerýär: gaýtalanýan bozulmalar üçin çäklendirme berilýär.',
  'reportCourierSend': 'Şikaýaty ugratmak',
  'reportCourierSent': 'Şikaýat ugradyldy',
  'reportCourierFailed': 'Şikaýaty ugratmak başartmady',
  'reportReasonRude': 'Gödek gepledi',
  'reportReasonExtortion': 'Birnäçe sargyt talap etdi',
  'reportReasonNoDoor': 'Gapa çenli galmady',
  'reportReasonLate': 'Gijä galdy',
  'reportReasonNoContact': 'Habarlaşmady',
  'reportReasonNotDelivered': 'Sargydy eltmedi',
  'editOrderBtn': 'Sargydy üýtgetmek',
  'editOrderTitle': 'Sargydy üýtgetmek',
  'editOrderCourierNotice': 'Eltip beriji sargydy eýýäm aldy — üýtgeşmeler barada habar alar.',
  'editOrderSave': 'Üýtgeşmeleri ýatda saklamak',
  'editOrderFailed': 'Ýatda saklamak başartmady. Baglanyşygy barlaň we gaýtadan synanyşyň.',
  'editOrderTimeSection': 'Eltip beriş wagty',
  'editOrderTimeNotSet': 'Görkezilmedik',
  'editOrderPickDistrict': 'Nirä eltmeli',
  ...
  'updateRequiredNoLink': 'Täze wersiýa üçin goldaw gullugyna ýüz tutuň',
  'updateRequiredYourVersion': 'Siziň wersiýaňyz',
  'orderAlreadyTakenBody': 'Siz tassyklaýarkaňyz, sargydy başga eltip beriji aldy. Žetonlar alynmady.',
  ...
  'filterPickDistrict': 'Raýon saýla',
  ...
  'topUpBalanceLabel': 'Häzirki balans:',
  'topUpTokensUnit': 'nişan',
  'topUpTokensUnitShort': 'nşn.',
  'topUpSectionTokensAmount': 'NIŞAN MUKDARY',
  'topUpBadgePopular': 'Meşhur',
  'topUpBadgeProfitable': 'Bähbitli',
  'topUpCustomAmountHint': 'Ýa-da öz mukdaryňyzy giriziň...',
  'topUpSummaryYouGet': 'Alarsyňyz',
  'topUpPayBtn': 'Töleg etmek',
  'topUpSecurityNote': 'Bank arkaly howpsuz töleg',
  'topUpTourPackagesTitle': 'Nişan paketleri',
  'topUpTourPackagesBody': 'Taýyn paketi saýlaň ýa-da öz mukdaryňyzy giriziň.',
  'topUpTourPayTitle': 'Töleg',
  'topUpTourPayBody': 'Banky saýlaň we töleg etmek üçin düwmä basyň.',
  ...
  'orderDoorDeliveryLabel': 'Gapa çenli eltip bermek',
  'orderDoorDeliveryHint':
      'Eltip beriji ýokary galyp, sargydy gapyda gowşurar',
  'orderDoorDeliveryCourierHint':
      'Sargyt eden ýokary galyp, gapyda gowşurmagy haýyş edýär',
  ...
  'trustedCouriersTitle': 'Ynamly kurýerler',
  'trustedMenu': 'Ynamly kurýerler',
  'trustedHint': 'Gymmat sargytlary diňe şu kurýerler görer. Beýlekiler almaz.',
  'trustedEmptyTitle': 'Sanaw entek boş',
  'trustedEmptyBody': 'Ynanýan kurýerleriňizi goşuň. Gymmat sargytlar diňe olara görner — beýleki kurýerler beýle sargydy görmez.',
  'trustedAddBtn': 'Goşmak',
  'trustedPickTitle': 'Kimi goşmaly',
  'trustedPickSubtitle': 'Sargytlaryňyzy eýýäm daşan kurýerler.',
  'trustedNoCandidates': 'Hödürlär ýaly entek hiç kim ýok: kurýerli tamamlanan sargydyňyz ýok.',
  'trustedDeliveries': 'Sizde {n} gezek daşady',
  'trustedAdded': '{name} — ynamlylarda',
  'trustedRemoved': '{name} ynamlylardan aýryldy',
  'trustedRemoveTitle': 'Ynamlylardan aýyrmalymy?',
  'trustedRemoveBody': '{name} indi gymmat sargytlaryňyzy görmez. Eýýäm alan sargydy onda galar.',
  'trustedRemoveConfirm': 'Aýyrmak',
  'trustedAlreadyAdded': 'Bu kurýer eýýäm sanawda',
  ...
  // ── Приведи друга ──────────────────────────────────────────────────────
  'refMenu': 'Dostuňy çagyr',
  'refTitle': 'Dostuňy çagyr',
  'refHowTitle': 'Bu nähili işleýär',
  'refStep1': 'Dostuňyzyň belgisini ýazyň — ol programmany ýüklemänkä.',
  'refStep2': 'Dost şol belgi bilen kurýer bolup hasaba durýar.',
  'refStep3': 'Ol ilkinji sargydy ýerine ýetirýär — size {n} žeton gelýär.',
  'refInviteBtn': 'Çagyrmak',
  'refAskTitle': 'Dostuň belgisi',
  'refAskSubtitle': 'Diňe programmada entek ýok adamy çagyryp bolýar.',
  'refAskSubmit': 'Çagyrmak',
  'refEmpty': 'Siz entek hiç kimi çagyrmadyňyz. Dostuňyzyň belgisini ýazyň — ol ilkinji sargydy ýerine ýetirende žetonlar size geler.',
  'refSummary': 'Çagyrylan: {friends} · Alnan žeton: {tokens}',
  'refStatusWaiting': 'Hasaba durmagyna garaşylýar',
  'refStatusRegistered': 'Hasaba durdy — ilkinji sargyda garaşylýar',
  'refStatusPaid': '{n} žeton berildi',
  'refInvited': 'Çagyryş iberildi',
  'refCancelled': 'Çagyryş aýryldy',
  'refErrBadPhone': 'Belgini barlaň',
  'refErrSelf': 'Bu siziň öz belgiňiz',
  'refErrRegistered': 'Bu belgi programmada eýýäm bar',
  'refErrInvited': 'Bu belgi eýýäm çagyrylan',
  'refErrLimit': 'Hasaba durmagyna garaşýan çagyryş gaty köp',
