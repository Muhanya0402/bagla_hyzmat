...
- [ ] **Step 1: Проверить, как смешиваются стили фильтров**
...
- [ ] **Step 1: Чистое правило — отдельной функцией**
...
- [ ] **Step 2: Параметр `trustedOnly` в `createOrder`**
